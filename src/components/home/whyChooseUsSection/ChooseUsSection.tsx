...
import { CHOOSES } from "@/data/home/choooseUs";
  ...
  return (
    <AnimationFadeUpComponent>
      <BoxLayoutSection>
        ...
        />
        <div className="flex flex-wrap gap-5 sm:gap-8 items-center justify-center">
          {CHOOSES.map((choose, index) => (
            <div
              className={`flex-1 min-w-[200px] max-w-[290px] ${
                index % 2 === 0 ? "md:pb-10" : "md:pt-10"
              }`}
              key={choose.id}
            >
